...
class StripePaymentController extends Controller
{
    ...
    public function stripePost(Request $request)
    {
        ...
        Stripe\Charge::create ([
                "amount" =>100 * $data['sub_total']+$data['del_charge'] - ($data['discount']),
                "currency" => "bdt",
            ...
            $order_id = Order::insertGetId([
                ...
                'delivery_charge'=>$data['del_charge'],
                'total'=>$data['sub_total']+$data['del_charge'] - ($data['discount']),
            ...
            $total_amount = $data['sub_total']+$data['del_charge'] - ($data['discount']);
