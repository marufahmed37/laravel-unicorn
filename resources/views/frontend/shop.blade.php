                ...
                <aside class="sidebar_section p-0 mt-0">
                    <div class="sb_widget">
                        ...
                        <div class="filter_sidebar">
                            ...
                            <div class="fs_widget">
                                <h3 class="fs_widget_title">Filter by Sizes</h3>
                                        ...
                                        <span class="price">
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi> <span class="woocommerce-Price-currencySymbol">BDT</span>{{$product->after_discount}} </bdi>
                                                </span>
                                            </ins>
                                        </span>
...
<script>
    ...
    $('.search_btn').click(function(){
        ...
        var link = "{{route('shop')}}"+"?q="+search_input+"&category_id="+category_id+"&color_id="+color_id+"&size_id="+size_id+"&price_range="+price_range;
    ...
    $('#price_range').bind('mousemove', function(){
        var search_input = $('#search_input').val();
        var category_id = $('#category_id :selected').val();
        var color_id = $('#color_id :selected').val();
        var size_id = $('#size_id :selected').val();
