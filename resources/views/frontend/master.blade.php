                            ...
                            <ul class="header_select_options ul_li">
                                <li>
                                    <div class="select_option">
                                        <div class="flug_wrap">
                                            <img src="{{ asset('/front/images/flug/flug_uk.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <select>
                    ...
                    <div class="row align-items-center">
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="index.html">
                                    <img src="{{ asset('/front/images/logo/logo_1x.png') }}"
                                        srcset="{{ asset('/front/images/logo/logo_2x.png') }} 2x" alt>
                                </a>
                            </div>
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="advance_serach">
                                    ...
                                    <div class="form_item">
                                        <input type="search" value="{{@$_GET['q']}}" id="search_input"name="search" placeholder="Search Prudcts...">
                                        ...
                                        <ul class="allcategories_list ul_li_block">
                                            @foreach (App\Models\Category::all() as $category)
                                                <li><a href="shop_grid.html"><i class="icon icon-Starship"></i>
                                                        ...
                                                        ({{ App\Models\Product::where('category_id', $category->id)->count() }})</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    ...
                                    @auth('customerlogin')
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item" href="{{ route('customer.account') }}">My
                                                        Account</a></li>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_about">
                                <div class="brand_logo">
                                    <a class="brand_link" href="index.html">
                                        <img src="{{ asset('/front/images/logo/logo_1x.png') }}"
                                            srcset="{{ asset('/front/images/logo/logo_2x.png') }} 2x"
                                            alt="logo_not_found">
                                    </a>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    <li><a href="#!"><img src="{{ asset('/front/images/app_store.png/') }}"
                                                alt="app_store"></a></li>
                                    <li><a href="#!"><img src="{{ asset('/front/images/play_store.png/') }}"
                                                alt="play_store"></a></li>
                                </ul>
                            </div>
                        </div>
