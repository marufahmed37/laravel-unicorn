        ...
        <div class="cart_btns_wrap">
            <div class="row">
                <div class="col col-lg-6">
                    @php
                        session([
                            'discount'=>($type == 'percentage'?$sub_total - ($sub_total*$discount)/100:$discount),
                        ])
                    @endphp
            ...
            <div class="col col-lg-12">
                <div class="cart_total_table">
                    ...
                    <ul class="ul_li_block">
                        ...
                        <li>
                            <span>Discount</span>
                            <span>{{$discount}} {{($type == 'percentage'?'%':'bdt')}}</span>
                        </li>
                        <li>
                            <span>Order Total</span>
                            <span class="total_price">
                                {{($type == 'percentage'?$sub_total - ($sub_total*$discount)/100:$sub_total-$discount)}}
                            </span>
                        </li>
                    </ul>
                </div>
